...
app.set("views", "views"); //1st placeholder views the page and 2nd placeholder filename
...
io.on("connection", function (socket) {
  if(socket.request.session.user){
    ...
    socket.on("chatMessageFromBrowser", function (data) {
      ...
      message: sanitizeHTML(data.message, {allowedAttributes: {},allowedTags:[]}), username: user.username, avatar: user.avatar
    });
    });
  }
})
